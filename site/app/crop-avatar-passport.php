<?php
    class CropAvatar {
        ...
        private $type;
        private $extension;
        private $srcDir = 'assets/avatars';
        private $dstDir = 'assets/avatars';
        private $msg;
        ...
        private function crop($src, $dst, $data) {
            if (!empty($src) && !empty($dst) && !empty($data)) {
                ...
                $dst_img = imagecreatetruecolor(175, 225);
                $result = imagecopyresampled($dst_img, $src_img, 0, 0, $data -> x, $data -> y, 175, 225, $data -> width, $data -> height);
